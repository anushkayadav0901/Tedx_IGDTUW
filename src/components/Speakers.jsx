          ...
          {speakersData.map((speaker, index) => (
            ...
            >
              <div
                ...
                className="speaker-card-tilt relative h-56 sm:h-72 lg:h-80 overflow-hidden bg-pure-black"
              ...
              >
                <div className="speaker-card-media-inner absolute inset-0 flex items-center justify-center">
                  <p className="text-white/40 text-sm relative z-[1]">Speaker Photo</p>
                </div>
                <div className="speaker-card-media-fade" aria-hidden />
              </div>
              <div className="px-5 py-5 sm:px-6 sm:py-6 flex flex-col flex-1">
                <h3 className="text-2xl font-bold mb-2 group-hover:text-ted-red transition-colors duration-[250ms] ease-out">
                  {speaker.name}
                </h3>
                <div className="w-12 h-0.5 bg-ted-red mb-2 transform origin-left scale-x-100 group-hover:scale-x-[1.15] transition-transform duration-[250ms] ease-out" />
