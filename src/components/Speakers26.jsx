...
import anushka from '../assets/speakers26/anushka-narula.jpg';
import inoshi from '../assets/speakers26/inoshi-sharma.jpg';
import vidhu from '../assets/speakers26/vidhu-singh.jpg';
import supriya from '../assets/speakers26/supriya-kapoor.jpg';

gsap.registerPlugin(ScrollTrigger);

const speakers26 = [
  {
    role: 'Ms. Anushka Narula',
    focus: "An IGDTUW alumna now working as an SWE at Adobe, her journey reflects strong technical growth. From campus to corporate, she’s navigated the realities of building a career in tech. A story of consistency, learning, and seizing opportunities. Perfect for anyone aiming to break into the industry.",
    image: anushka
  },
  {
    role: 'Ms. Inoshi Sharma',
    focus: "Serving as Additional Director General in the Income Tax Department, her career reflects years of public leadership. She has worked at the core of India’s administrative and financial systems. A journey shaped by responsibility, decision-making, and impact. Learn what it takes to lead within governance.",
    image: inoshi
  },
  {
    role: 'Wg Cdr. Vidhu Singh',
    focus: "A former Indian Air Force officer, her career stands on discipline, precision, and leadership. She has served in one of the country's most demanding professions. Beyond the uniform, she continues to inspire through her experiences.",
    image: vidhu
  },
  {
    role: 'Supriya Kapoor',
    focus: "Supriya Kapoor is a celebrated radio jockey, voice artist, and digital content creator who has worked across India’s top radio networks, including Radio Mirchi (Times Group), Ishq FM (India Today), and Fever FM (Hindustan Times).\nKnown for her creativity and relatability, Supriya’s original IPs—like her viral Alexa mimicry “Alepsa”—have captured widespread attention online.\nShe continues to collaborate with top brands such as Amazon India, Google Pixel, Acko, and MakeMyTrip, blending storytelling, humor, and performance into everything she creates.",
    image: supriya
  }
];

const Speakers26 = memo(({ config = { enableHeavyAnimations: true } }) => {
    ...
    >
      <div className="max-w-7xl mx-auto w-full min-w-0">
        <h2 ref={titleRef} className="text-[clamp(2rem,5vw+1rem,3.75rem)] md:text-6xl font-bold mb-6 sm:mb-10 text-center px-4">
          TEDx'26 <span className="text-ted-red">Speakers</span>
        </h2>
        <p className="text-center text-white/60 text-sm sm:text-base max-w-2xl mx-auto mb-10 md:mb-16 px-4">
          From bold leaders to creative minds — speakers bringing ideas that shape tomorrow.
        </p>
        ...
        <div 
          ...
          className="flex overflow-x-auto snap-x snap-mandatory pt-4 pb-12 px-4 md:px-0 md:grid md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-8 overflow-y-visible scrollbar-hide md:overflow-visible"
              ...
              >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    {speaker.image ? (
                      <img 
                        src={speaker.image} 
                        alt={speaker.role} 
                        className="w-full h-full object-cover object-[center_20%] transition-transform duration-[850ms] ease-[cubic-bezier(0.25,0.8,0.25,1)] md:group-hover/card:scale-[1.1] max-md:scale-105" 
                      />
                    ) : (
                ...
                <div className="relative px-5 py-6 md:px-7 md:py-8 flex flex-col flex-1 bg-pure-black rounded-b-2xl z-10 transition-colors duration-700 md:group-hover/card:bg-gradient-to-b md:group-hover/card:from-pure-black md:group-hover/card:to-[#140202]">
                  ...
                  <div className="
                    ...
                    line-clamp-3 md:line-clamp-none whitespace-pre-wrap
...
Speakers26.displayName = 'Speakers26';

export default Speakers26;
